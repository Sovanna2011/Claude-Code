...
import (
	...
	"github.com/sovanna2011/farm-area/backend/internal/config"
	"github.com/sovanna2011/farm-area/backend/internal/database"
	"github.com/sovanna2011/farm-area/backend/internal/httpapi"
	"github.com/sovanna2011/farm-area/backend/internal/repository"
	"github.com/sovanna2011/farm-area/backend/internal/service"
)
...
func run(log *slog.Logger) error {
	...
	services := service.New(db, master, dashboard, support)
