...
IF @Level > (SELECT compatibility_level FROM sys.databases WHERE name = N'{DATABASE}')
BEGIN
    DECLARE @Sql nvarchar(200) =
        N'ALTER DATABASE [{DATABASE}] SET COMPATIBILITY_LEVEL = ' + CAST(@Level AS nvarchar(3)) + N';';
