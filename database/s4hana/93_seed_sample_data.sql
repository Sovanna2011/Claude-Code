...
VALUES (@Tenant, N'RF_BELEG', N'Accounting document', 1, 1, 10, N'KSS',
        N'{Prefix}-{Year}-{Type}-{Number:0000000000}', 1, @By),
...
DECLARE @Doc1 nvarchar(20) = N'KSS-2026-DR-0000000001';
DECLARE @Doc2 nvarchar(20) = N'KSS-2026-KR-0000000001';
DECLARE @Doc3 nvarchar(20) = N'KSS-2026-DZ-0000000001';
DECLARE @Doc4 nvarchar(20) = N'KSS-2026-SA-0000000001';
DECLARE @Doc5 nvarchar(20) = N'SCT-2026-SA-0000000001';
DECLARE @Doc6 nvarchar(20) = N'KSS-2026-AA-0000000001';
DECLARE @Doc7 nvarchar(20) = N'KSS-2026-AA-0000000002';
