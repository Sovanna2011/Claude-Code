...
| | |
|---|---|
| **[`backend/ErpS4.Application/`](backend/ErpS4.Application/README.md)** | Posting engine, Business Partner role synchronisation and open item clearing — 65 tests covering the mandatory rules |
| **[`backend/ErpS4.Api/`](backend/ErpS4.Api/README.md)** | .NET 10 minimal API — journal entries, business partners, payments and open items, permission policies resolved from the security tables, RFC 7807 problems, capped paging |
