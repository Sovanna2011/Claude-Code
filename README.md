...
| | |
|---|---|
| **[`backend/ErpS4.Application/`](backend/ErpS4.Application/README.md)** | Posting engine and Business Partner role synchronisation — 52 tests covering the mandatory rules |
| **[`backend/ErpS4.Api/`](backend/ErpS4.Api/README.md)** | .NET 10 minimal API — journal entries and business partners, permission policies resolved from the security tables, RFC 7807 problems, capped paging |
