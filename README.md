...
| | |
|---|---|
| **[`backend/ErpS4.Application/`](backend/ErpS4.Application/README.md)** | Posting engine, Business Partner synchronisation, clearing and asset accounting — 77 tests covering the mandatory rules |
| **[`backend/ErpS4.Api/`](backend/ErpS4.Api/README.md)** | .NET 10 minimal API — journal entries, business partners, payments, open items and assets, permission policies resolved from the security tables, RFC 7807 problems, capped paging |
